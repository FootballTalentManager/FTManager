...
<head>
    ...
    <title>Football Talent Manager - Gerir Equipas</title>
            ...
            <div class="container-fluid px-4">
                ...
                <div class="row" style="border-bottom: 2px solid black; padding-bottom: 1rem;">
                    <div class="col-md-auto">
                        <h2 class="mt-4"><span class="iconify-inline" data-icon="eos-icons:content-lifecycle-management" data-width="30" data-height="30"></span>  Gerir Equipas</h2>
                    </div>
                </div>
                ...
                <div class="row" style="margin-top: 2rem !important">
                    <div class="card mb-4" style="padding-right: 0; padding-left: 0;">
                        ...
                        <div class="card-body">
                            <form method="post" action="formGerirEquipas.php" id="tableForm">
                                <table id="table" class="table table-hover" style="width:100% !important;">
                                    ...
                                    <?php
                                        ...
                                        if ($queryResult->num_rows > 0){
                                            while($row = mysqli_fetch_row($queryResult)){
                                                ?>
                                                    <tr class="clickable-row" style="cursor: pointer;" id="<?php echo $row[0] ?>">
...
<script src="js/dataTables/dataTable-gerirEquipas.js"></script>
<script>
    function getEpocas (){
