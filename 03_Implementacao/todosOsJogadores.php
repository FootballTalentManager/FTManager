...
<html lang="pt">
    <head>
        ...
        <title>Football Talent Manager - Todos os Jogadores</title>
                ...
                <div class="container-fluid px-4">
                    <div class="row" style="border-bottom: 2px solid black; padding-bottom: 1rem;">
                        <div class="col-md-auto">
                            <h2 class="mt-4"><span class="iconify-inline" data-icon="fluent:people-audience-20-regular" data-width="30" data-height="30"></span> Todos os Jogadores do Clube</h2>
                        </div>
                    </div>
                    <div class="row" style="margin-top: 2rem !important">
                        <div class="card mb-4" style="padding-right: 0; padding-left: 0;" >
                            <div class="card-header">
                                <h6><span class="iconify-inline" data-icon="ri:team-fill" data-width="20" data-height="20"></span>  Jogadores</h6>
                            </div>
                            <div class="card-body">
                                <form method="post" action="formSubmitJogador.php" name="formChanges" enctype="multipart/form-data">
                                    <table id="table" class="table table-hover" style="width:100% !important;">
                                        ...
                                        <tbody>
                                            <?php
                                            $queryGetEquipaTecnica = "SELECT * FROM `$dataBaseName`.`jogador`";
                                            ...
                                            if ($queryResult->num_rows > 0){
                                                while($row = mysqli_fetch_row($queryResult)){
                                                    ...
                                                    $BIXml = $curriculo['bilheteIdentidade'];
                                                    $nomeXml = $curriculo['nome'];
                                                    $alcunhaXml = $curriculo['alcunha'];
                                                    $moradaXml = $curriculo['morada'];
                                                    $nacionalidadeXml = $curriculo['nacionalidade'];
                                                    $dataNascimentoXml = $curriculo['dataNascimento'];
                                                    $numeroXml = $curriculo['numero'];
                                                    ...
                                                    if ($BI == $BIXml){
                                                        ...
                                                        <tr style="cursor: pointer;">
                                                            ...
                                                            <td><?php echo $nacionalidadeXml ?></td>
                                                            <td><?php echo $dataNascimentoXml?></td>
                                                            <td><?php echo $moradaXml?></td>
                                                            <td><?php echo $Telemovel?></td>
                                                            <td><?php echo $numeroXml?></td>
                                                        </tr>
                                                        <?php
                                                    }
                                                }
                                ...
                                <form method="post" name="formPlayerPage" action="perfilJogador.php">
                                    ...
                                    <input type="hidden" value="<?php echo $isTreinador ?>" name="isTreinador"/>
                                </form>
                            </div>
                        </div>
                    </div>
    ...
    <script src="js/dataTables/datatables-todosOsJogadores.js"></script>
